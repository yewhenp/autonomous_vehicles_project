...
if __name__ == '__main__':
    ...
    # main("data/arrow_medium_resolution", inserter="user/high_resolution_enable")
    # main("data_new/right_side_car_1", inserter="user/right_side_car")
    # main("data_new/stop_sign_1", inserter="user/stop_sign")
    # main("data_new/pedestrian_1", inserter="user/pedestrian")
    # main("data_new/pedestrian_start_1", inserter="user/pedestrian_start")
    # main("data_new/stop_sign_2", inserter="user/stop_sign")
    main("data_new/pedestrian_2", inserter="user/pedestrian")
